            ...
            return (
              <div>
                ...
                <Container className="App">
                  ...
                  >
                    <ModalHeader className="modalHeader" toggle={onCloseBookingModal}>
                      Please Enter Your Contact Information.
                    </ModalHeader>
                    <ModalBody className="modal-body">
                      <Form className="form-inline" onSubmit={onBookTimeSlot}>
                        <FormGroup className="form-group">
                          <Label className="form-group" for="contactName">Your Name</Label>
                        ...
                        <FormGroup className="form-group">
                          <Label className="form-group" for="contactPhone">Your Phone Number</Label>
                          <Input className="form-group"
                            type="tel"
                            name="contactPhone"
                            id="contactPhone"
                  ...
                  >
                    ...
                    <ModalBody>
                      <Form className="form-inline" onSubmit={onUpdateTimeSlot}>
                        <FormGroup className="form-group">
                          <Label className="form-group" for="contactName2">Your Name</Label>
                          <Input className="form-group"
                            type="text"
                            name="contactName"
                            id="contactName2"
                        ...
                        <FormGroup className="form-group">
                          <Label className="form-group" for="contactPhone2">Your Phone Number</Label>
                          <Input className="form-group"
                            type="tel"
                            name="contactPhone"
                            id="contactPhone2"
